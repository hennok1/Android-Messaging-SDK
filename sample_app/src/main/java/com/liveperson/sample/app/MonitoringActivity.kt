...
class MonitoringActivity : AppCompatActivity() {
    ...
    private var enviornmentSpinner: Spinner? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getEngagementButton.setOnClickListener {
            ...
            showProgressBar()
            try {
                val environment: String = enviornmentSpinner?.getSelectedItem().toString()
    ...
    private fun initEnvironmentSpinner() {
        enviornmentSpinner = findViewById(R.id.environment_spinner);
        val environments = resources.getStringArray(R.array.environments);

        if (enviornmentSpinner != null) {
            val adapter = ArrayAdapter(this,
                    android.R.layout.simple_spinner_item, environments)
            enviornmentSpinner!!.adapter = adapter
        }
    }
}
